...
<div class="btn-group mb-3">
    <a href="/reports/income?from=<?= htmlspecialchars($from) ?>&to=<?= htmlspecialchars($to) ?>&format=csv" class="btn btn-outline-secondary btn-sm"><i class="fa-solid fa-download me-1"></i>CSV</a>
    <a href="/reports/income?from=<?= htmlspecialchars($from) ?>&to=<?= htmlspecialchars($to) ?>&format=pdf" class="btn btn-outline-secondary btn-sm"><i class="fa-solid fa-file-pdf me-1"></i>PDF</a>
    <a href="/reports/income?from=<?= htmlspecialchars($from) ?>&to=<?= htmlspecialchars($to) ?>&format=xlsx" class="btn btn-outline-secondary btn-sm"><i class="fa-solid fa-file-excel me-1"></i>Excel</a>
</div>
