...
<a href="/reports/visitors?from=<?= htmlspecialchars($from) ?>&to=<?= htmlspecialchars($to) ?>&format=csv" class="btn btn-outline-secondary btn-sm mb-3"><i class="fa-solid fa-download me-1"></i>Export CSV</a>
