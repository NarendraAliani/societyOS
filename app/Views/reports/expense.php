...
<form method="get" action="/reports/expense" class="row g-2 mb-3" style="max-width: 480px;">
        ...
        <table class="table table-hover align-middle">
            ...
            <?php foreach ($rows as $row): ?>
                <tr>
                    ...
                    <td class="text-end text-danger fw-bold"><?= number_format((float) $row['amount'], 2) ?></td>
                </tr>
            <?php endforeach; ?>
            <?php if (empty($rows)): ?>
                <tr><td colspan="5" class="text-center text-muted py-4">No expenses in this range.</td></tr>
            <?php endif; ?>
            </tbody>
            <?php if (!empty($rows)): ?>
